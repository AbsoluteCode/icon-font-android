...
import static de.absoluteco.icon_font_android.FontHelper.replaceIcons;
/**
 * Created by Vincent.VanZyl on 2015/04/14.
 */
public abstract class Iconify {
    protected static String TTF_FILE = "fontawesome-webfont-4.3.0.ttf";
    ...
    public static final void setIcon(TextView textView, IconValue value) {
        textView.setTypeface(getTypeface(textView.getContext()));
        textView.setText(String.valueOf(value.character));
    }
